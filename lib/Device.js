...
class Device
{
  ...
  handleEirDataStructure(eirDataStructure)
  {
    ...
    {
      case btHci.EirDataType.LocalNameComplete:
        this.changeState('localName', eirDataStructure.value);
        break;

      case btHci.EirDataType.TxPowerLevel:
        this.changeState('txPowerLevel', eirDataStructure.value);
        break;

      case btHci.EirDataType.ManufacturerSpecificData:
  ...
  handleEirManufacturerSpecificData(msd)
  {
    ...
    switch (msd.model)
    {
      case iNodeHci.DeviceModel.CareRelay:
        this.handleCareRelayMsd(msd);
        break;

      case iNodeHci.DeviceModel.EnergyMeter:
        this.handleEnergyMeterMsd(msd);
        break;

      case iNodeHci.DeviceModel.CareSensor1:
      case iNodeHci.DeviceModel.CareSensor2:
      case iNodeHci.DeviceModel.CareSensor3:
      case iNodeHci.DeviceModel.CareSensor4:
      case iNodeHci.DeviceModel.CareSensor5:
      case iNodeHci.DeviceModel.CareSensor6:
      case iNodeHci.DeviceModel.CareSensorT:
      case iNodeHci.DeviceModel.CareSensorHT:
  ...
  handleEnergyMeterMsd(msd)
  {
    ...
    this.changeState('sumUnit', msd.sumUnit);
    this.changeState('averageUnit', msd.averageUnit);
